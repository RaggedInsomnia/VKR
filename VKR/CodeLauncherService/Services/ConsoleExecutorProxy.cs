...
{
    public class ConsoleExecutorProxy : IProcessExecutorProxy
    {
        private readonly TimeSpan _timeOut;
        private readonly ILogger<ConsoleExecutorProxy> _logger;

        public ConsoleExecutorProxy(IOptions<CodeLauncherAppSettings> appSettings, ILogger<ConsoleExecutorProxy> logger)
        {
            _logger = logger;
